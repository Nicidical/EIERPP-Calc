...
function getEndOfTurn(gen, attacker, defender, move, field) {
    ...
    if (field.hasWeather('Sun', 'Harsh Sunshine')) {
        ...
        if (!defender.hasType('Rock', 'Ground', 'Steel') &&
            !defender.hasAbility('Magic Guard', 'Overcoat', 'Sand Force', 'Sand Rush', 'Sand Veil', 'Impenetrable') &&
        ...
        if (defender.hasAbility('Ice Body')) {
            ...
            !defender.hasAbility('Magic Guard', 'Overcoat', 'Snow Cloak', 'Impenetrable', 'North Wind') &&
            !defender.hasItem('Safety Goggles') &&
    ...
    if (defender.hasItem('Leftovers') && !loseItem) {
        ...
        else if (!defender.hasAbility('Magic Guard', 'Klutz', 'Impenetrable')) {
            damage -= Math.floor(defender.maxHP() / 8);
    ...
    if (field.attackerSide.isSeeded && !attacker.hasAbility('Magic Guard', 'Impenetrable')) {
    ...
    if (defender.isSaltCure && !defender.hasAbility('Magic Guard', 'Impenetrable')) {
